...
License  : MIT
Requires: azure-mgmt-deploymentmanager-python = %{version}-%{release}
Requires: azure-mgmt-deploymentmanager-python3 = %{version}-%{release}
...
%package python
Summary: python components for the azure-mgmt-deploymentmanager package.
Group: Default
Requires: azure-mgmt-deploymentmanager-python3 = %{version}-%{release}

%description python
python components for the azure-mgmt-deploymentmanager package.


%package python3
Summary: python3 components for the azure-mgmt-deploymentmanager package.
Group: Default
Requires: python3-core
Provides: pypi(azure_mgmt_deploymentmanager)
Requires: pypi(azure_common)
Requires: pypi(msrest)
Requires: pypi(msrestazure)

%description python3
python3 components for the azure-mgmt-deploymentmanager package.


%prep
%setup -q -n azure-mgmt-deploymentmanager-0.2.0
cd %{_builddir}/azure-mgmt-deploymentmanager-0.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588790550
